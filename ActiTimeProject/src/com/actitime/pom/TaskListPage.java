...
public class TaskListPage {
	...
	@FindBy(xpath="(//div[@class='itemRow cpltemRow' and text()='Own company']")
	private WebElement OwnCompanyMenu;
	...
	public WebElement getOwnCompanyMenu() {
		return OwnCompanyMenu;
	}
